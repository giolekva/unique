...
import (
	...
	"github.com/giolekva/unique/operator/generated/clientset/versioned/scheme"
...
func (c *LekvaV1Client) CountUniques(namespace string) CountUniqueInterface {
	return newCountUniques(c, namespace)
}
